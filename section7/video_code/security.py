...
def authenticate(username, password):
    ...
    with their username and passord.
...
def identity(payload):
    """
    Function that gets called when user has already autheticated, and FLASK-JWT verified their authorization header is correct.
